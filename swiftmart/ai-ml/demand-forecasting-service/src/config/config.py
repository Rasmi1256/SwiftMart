# ai-ml/demand-forecasting-service/src/config/config.py
import os
...
print(f"Demand Forecasting Service Configuration Loaded: Port={config.PORT}, ProductCatalogServiceURL={config.PRODUCT_CATALOG_SERVICE_URL}", flush=True)